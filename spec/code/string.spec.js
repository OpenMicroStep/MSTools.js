...
describe("==========Tests du package string========", function() {
	...
	it("Testing words array method", function() {
		expect("".wordsArray()).toEqual([]) ;
		expect("     !*,;/\\?\t § ".wordsArray()).toEqual([]) ;
		expect("     +% @& ".wordsArray()).toEqual([]) ;
		expect("La ponctuation a, en fait, cette vertu de fluidifier la phrase, de la rendre expressive, d’« être la marque visible de l’oralité ». Pour nous en faire prendre pleinement conscience, en fin de chapitre, après un récapitulatif des divers emplois, les deux auteurs ont ajouté, pour certains signes – leurs chouchous ? –, un petit exercice qui consiste à rétablir la ponctuation d’un texte, et dont la solution est donnée à la fin de l’ouvrage.".wordsArray().join(" ")).toBe("La ponctuation a en fait cette vertu de fluidifier la phrase de la rendre expressive d être la marque visible de l oralité Pour nous en faire prendre pleinement conscience en fin de chapitre après un récapitulatif des divers emplois les deux auteurs ont ajouté pour certains signes leurs chouchous un petit exercice qui consiste à rétablir la ponctuation d un texte et dont la solution est donnée à la fin de l ouvrage") ;
	}) ;
